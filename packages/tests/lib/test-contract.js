...
var contract = (function () {
    return new swisstronik_ethers_1.ethers.Contract(test_contract_json_1.default.contractAddress, test_contract_json_1.default.interface, provider);
})();
function equals(name, actual, expected) {
    ...
    if (typeof (actual) === 'object') {
        if (expected.indexed) {
            assert_1.default.ok(swisstronik_ethers_1.ethers.Contract.isIndexed(actual), 'index property has index - ' + name);
            if (expected.hash) {
...
describe("Test Contract Transaction Population", function () {
    ...
    var contract = new swisstronik_ethers_1.ethers.Contract(testAddress, abi);
    var contractConnected = contract.connect(swisstronik_ethers_1.ethers.getDefaultProvider());
